        ...
        >
          <div className="flex gap-4">
            <a
              ...
              className="flex items-center gap-2 px-3 py-2 bg-red-900/30 border border-red-500/30 rounded-lg hover:bg-red-900/50 hover:border-red-500/50 transition-all duration-300 group"
            >
              ...
              <span className="text-red-400 group-hover:text-red-300 font-mono text-sm transition-colors">
                Discord
              </span>
            </a>
            <a
            ...
            <a
              ...
              className="flex items-center gap-2 px-3 py-2 bg-red-900/30 border border-red-500/30 rounded-lg hover:bg-red-900/50 hover:border-red-500/50 transition-all duration-300 group"
            >
              <Terminal className="w-5 h-5 text-red-400 group-hover:text-red-300 transition-colors" />
              <span className="text-red-400 group-hover:text-red-300 font-mono text-sm transition-colors">
                Developer
              </span>
            </a>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-red-900/10 border border-red-500/20 rounded-lg p-8 mb-12">
            ...
            <div className="flex justify-center items-center w-full">
              <div className="bg-red-900/5 border border-red-500/20 rounded-lg p-8 w-full max-w-6xl">
                <div className="flex justify-center items-center">
                  <svg viewBox="0 0 720 180" className="w-full h-auto" style={{maxWidth: '850px'}}>
                    {/* Step 1: User Prompt */}
